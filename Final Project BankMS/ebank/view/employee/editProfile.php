                                ...
                                <div class="editdtls">
                                        ...
                                        <div class="edtname" id="edtnamef">
                                            ...
                                            <form action="../../controller/updateProfile.php" method="post">
                                                <input type="text" id="Name" name="Name" placeholder="Name of yours" required>
                                        ...
                                        <div class="edtuname" id="edtunamef">
                                            <p></p>
                                            <form action="../../controller/updateProfile.php" method="post">
                                                <input type="text" id="userName" name="userName" placeholder="Surname of yours" required>
                                        ...
                                        <div class="edtphn" id="edtphnf">
                                            <p></p>
                                            <form action="../../controller/updateProfile.php" method="post">
                                                <input type="text" id="phone" name="phone" placeholder="01**********" required>
